...
function plot_time_std_scatter(df1::DataFrame, df2::DataFrame;
...
>>>>>>> 81b77ac... Add xtick and yticks kwargs for specifying time and schedlength scatter plots separately
                               font_size = 15pt,
                               point_size = 3pt,
                               axis_font_size = 10pt,
                               tick_font_size = 6pt)
    ...
    p1 = Gadfly.plot(df_plot, x = :mean_min, y = :sd_logmdd, label = :temper_string, Guide.title(title1),
    ...
    p2 = Gadfly.plot(df_plot, x = :mean_schedlength, y = :sd_logmdd, label = :temper_string, Guide.title(title2),
...
function plot_time_std_scatter(df_plot::DataFrame; file_name::String = "scatter",
                               title1::String = "", title2::String = "",
                               plotroot::String = "",
                               xticks_time = 0:2:10,
                               yticks_time = 0:0.5:1.5,
