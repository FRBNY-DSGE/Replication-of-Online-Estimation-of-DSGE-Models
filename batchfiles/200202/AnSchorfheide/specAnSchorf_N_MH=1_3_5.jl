...
@everywhere SMC_DIR = ### INSERT PATH TO WHERE YOU GIT CLONED HERE
...
if run_estimations
    ...
    # Estimating whole
    setting_overrides[:date_mainsample_end] = Setting(:date_mainsample_end, quartertodate("2016-Q3"))
    estimate_model(model, T_star, run_date, subspec = "ss0", est_spec = est_spec, data_spec = data_spec,
        ...
        # Estimating old
        setting_overrides[:date_mainsample_end] = Setting(:date_mainsample_end, quartertodate("2007-Q1"))
